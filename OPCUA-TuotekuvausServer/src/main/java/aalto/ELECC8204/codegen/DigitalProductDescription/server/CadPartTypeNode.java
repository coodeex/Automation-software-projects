...
public class CadPartTypeNode extends CadPartTypeNodeBase {
  protected CadPartTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId, QualifiedName browseName,
