...
public abstract class ShaftTypeNodeBase extends CadPartTypeNode implements ShaftType {
  private static GeneratedNodeInitializer<ShaftTypeNode> shaftTypeNodeInitializer;

  protected ShaftTypeNodeBase(NodeManagerUaNode nodeManager, NodeId nodeId,
  ...
  public void afterCreate() {
    ...
    callAfterCreateIfExists(getmiddleNode());
    callAfterCreateIfExists(gettopNode());
    GeneratedNodeInitializer<ShaftTypeNode> impl = getShaftTypeNodeInitializer();
    if(impl != null) {
      impl.init((ShaftTypeNode)this);
    }
  }

  public static GeneratedNodeInitializer<ShaftTypeNode> getShaftTypeNodeInitializer() {
    return shaftTypeNodeInitializer;
  }

  public static void setShaftTypeNodeInitializer(GeneratedNodeInitializer<ShaftTypeNode> shaftTypeNodeInitializerNewValue) {
    shaftTypeNodeInitializer=shaftTypeNodeInitializerNewValue;
  }
  ...
  @Mandatory
  @Override
  public CoordinateTypeNode getmiddleNode() {
    QualifiedName browseName = getQualifiedName("http://opcfoundation.org/UA/", "middle");
    return (CoordinateTypeNode) getComponent(browseName);
  }
