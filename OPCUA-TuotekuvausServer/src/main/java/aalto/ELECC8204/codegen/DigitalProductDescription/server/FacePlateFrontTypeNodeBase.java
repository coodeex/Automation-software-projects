...
public abstract class FacePlateFrontTypeNodeBase extends CadPartTypeNode implements FacePlateFrontType {
  private static GeneratedNodeInitializer<FacePlateFrontTypeNode> facePlateFrontTypeNodeInitializer;

  protected FacePlateFrontTypeNodeBase(NodeManagerUaNode nodeManager, NodeId nodeId,
  ...
  public void afterCreate() {
    ...
    GeneratedNodeInitializer<FacePlateFrontTypeNode> impl = getFacePlateFrontTypeNodeInitializer();
    if(impl != null) {
      impl.init((FacePlateFrontTypeNode)this);
    }
  }

  public static GeneratedNodeInitializer<FacePlateFrontTypeNode> getFacePlateFrontTypeNodeInitializer() {
    return facePlateFrontTypeNodeInitializer;
  }

  public static void setFacePlateFrontTypeNodeInitializer(GeneratedNodeInitializer<FacePlateFrontTypeNode> facePlateFrontTypeNodeInitializerNewValue) {
    facePlateFrontTypeNodeInitializer=facePlateFrontTypeNodeInitializerNewValue;
  }
