 ...
 */
@TypeDefinitionId("nsu=DigitalProductDescription;i=107")
public abstract class BoltAngularTypeNodeBase extends CadPartTypeNode implements BoltAngularType {
  private static GeneratedNodeInitializer<BoltAngularTypeNode> boltAngularTypeNodeInitializer;

  protected BoltAngularTypeNodeBase(NodeManagerUaNode nodeManager, NodeId nodeId,
  ...
  public void afterCreate() {
    ...
    GeneratedNodeInitializer<BoltAngularTypeNode> impl = getBoltAngularTypeNodeInitializer();
    if(impl != null) {
      impl.init((BoltAngularTypeNode)this);
    }
  }

  public static GeneratedNodeInitializer<BoltAngularTypeNode> getBoltAngularTypeNodeInitializer() {
    return boltAngularTypeNodeInitializer;
  }

  public static void setBoltAngularTypeNodeInitializer(GeneratedNodeInitializer<BoltAngularTypeNode> boltAngularTypeNodeInitializerNewValue) {
    boltAngularTypeNodeInitializer=boltAngularTypeNodeInitializerNewValue;
  }
