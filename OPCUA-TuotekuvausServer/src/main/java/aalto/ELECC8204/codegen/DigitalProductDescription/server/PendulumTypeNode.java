...
public class PendulumTypeNode extends PendulumTypeNodeBase {
  protected PendulumTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId, QualifiedName browseName,
