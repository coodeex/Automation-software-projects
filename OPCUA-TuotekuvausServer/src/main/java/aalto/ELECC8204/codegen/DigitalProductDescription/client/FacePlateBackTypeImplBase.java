...
public abstract class FacePlateBackTypeImplBase extends CadPartTypeImpl implements FacePlateBackType {
  protected FacePlateBackTypeImplBase(AddressSpace addressSpace, NodeId nodeId,
  ...
  @Mandatory
  @Override
  public CoordinateType getsquare_leftNode() {
  ...
  @Mandatory
  @Override
  public CoordinateType getsquare_rightNode() {
  ...
  @Mandatory
  @Override
  public CoordinateType getcircle_leftNode() {
  ...
  @Mandatory
  @Override
  public CoordinateType getcircle_rightNode() {
  ...
  @Mandatory
  @Override
  public CoordinateType getshaftNode() {
