...
public abstract class BoltAngularTypeImplBase extends CadPartTypeImpl implements BoltAngularType {
  protected BoltAngularTypeImplBase(AddressSpace addressSpace, NodeId nodeId,
