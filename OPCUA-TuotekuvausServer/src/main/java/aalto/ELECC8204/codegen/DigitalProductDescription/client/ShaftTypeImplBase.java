...
public abstract class ShaftTypeImplBase extends CadPartTypeImpl implements ShaftType {
  protected ShaftTypeImplBase(AddressSpace addressSpace, NodeId nodeId, QualifiedName browseName,
  ...
  @Mandatory
  @Override
  public CoordinateType getmiddleNode() {
