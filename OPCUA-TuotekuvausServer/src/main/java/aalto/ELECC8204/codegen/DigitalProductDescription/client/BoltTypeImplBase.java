...
public abstract class BoltTypeImplBase extends CadPartTypeImpl implements BoltType {
  protected BoltTypeImplBase(AddressSpace addressSpace, NodeId nodeId, QualifiedName browseName,
