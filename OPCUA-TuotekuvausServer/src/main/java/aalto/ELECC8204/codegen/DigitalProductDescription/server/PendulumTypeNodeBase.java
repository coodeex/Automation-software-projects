...
public abstract class PendulumTypeNodeBase extends CadPartTypeNode implements PendulumType {
  private static GeneratedNodeInitializer<PendulumTypeNode> pendulumTypeNodeInitializer;

  protected PendulumTypeNodeBase(NodeManagerUaNode nodeManager, NodeId nodeId,
  ...
  public void afterCreate() {
    ...
    GeneratedNodeInitializer<PendulumTypeNode> impl = getPendulumTypeNodeInitializer();
    if(impl != null) {
      impl.init((PendulumTypeNode)this);
    }
  }

  public static GeneratedNodeInitializer<PendulumTypeNode> getPendulumTypeNodeInitializer() {
    return pendulumTypeNodeInitializer;
  }

  public static void setPendulumTypeNodeInitializer(GeneratedNodeInitializer<PendulumTypeNode> pendulumTypeNodeInitializerNewValue) {
    pendulumTypeNodeInitializer=pendulumTypeNodeInitializerNewValue;
  }
