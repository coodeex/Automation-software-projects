...
public abstract class CadPartTypeImplBase extends DigitalPartTypeImpl implements CadPartType {
  protected CadPartTypeImplBase(AddressSpace addressSpace, NodeId nodeId, QualifiedName browseName,
