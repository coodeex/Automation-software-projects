...
public abstract class FacePlateFrontTypeImplBase extends CadPartTypeImpl implements FacePlateFrontType {
  protected FacePlateFrontTypeImplBase(AddressSpace addressSpace, NodeId nodeId,
